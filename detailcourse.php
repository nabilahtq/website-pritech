...
<head>
    ...
    <link rel="stylesheet" href="styledet2.css">
...
<section>
  ...
  <div class="jumbotron " >
    ...
    <p><?php echo date('d F Y', strtotime($data["tanggal"]));?> - <?php echo date('d F Y', strtotime($data["tanggal_end"]));?></p>
    <div class="d-flex mt-4">
        <font color="black"><p><?php echo $data['nama']; ?> | <?php echo $data['pekerjaan']; ?></p></font>
    </div>
  </div>

<div class="container-fluid bcontent">
        <h2>Kategori | <?php echo $data['ahli']; ?></h2>
        <hr />
        <div class="row">
        <div class="col-md-9 col-sm-14 mb-3">
            <div class="card" >
            <div class="row no-gutters">
                <div class="col-sm-5">
                    <img class="card-img img-fluid" src="course/<?php echo $data['gambar']; ?>" style="width: 400px; height: 300px;">
                </div>
                <div class="col-sm-5">
                    <div class="card-body">
                        <h5 class="card-title" ><b>Tentang Kursus</b></h5>
                        <p class="card-text" style="text-align: justify;"><?php echo $data['deskripsi_co']; ?></p>
                    </div>
                </div>
            </div>
            </div>
        ...
        <div class="col-md-3 col-sm-12 mb-3">
            <div class="card">
                ...
                <p class="card-text"><b>Platform : </b> Via Zoom&nbsp;&nbsp;|&nbsp;&nbsp;<b>Software : </b><?php echo $data['software']; ?></p>
                <h6>
                    <s class="text-secondary\">Rp.<?= number_format($data['harga_asli'],2) ?></s>
                    <span class="price"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Rp.<?= number_format($data['harga_diskon'],2) ?></b></span>
                    </h6>
                </div>
                <div class="card-footer">
        
                    <button class="btn btn-warning btn-block add-to-cart"><a href="checkout.php?course_id=<?php echo $data['course_id']; ?> " id="course_id" class="btn btn-warning btn-block add-to-cart"><i class="fa fa-shopping-cart"></i>Buy Training</a></button>
...
<div class="container-fluid bcontent">
        ...
        <div class="col-md-9 col-sm-14 mb-3">
            ...
            <div class="row no-gutters">
                <div class="col-sm-5">
                    <center>
                    <img src="assets/images/tutor/<?php echo $data['foto']; ?>" class="rounded-circle" height="250" widht="250">
                </center>
                </div>
                <div class="col-sm-5">
                    <div class="card-body">
