...
<html>
    ...
    <body>
		<div class="wrapper">
			<h1>Selamat datang di Pritech</h1>
			<h2>Online Course With <span>Pritech</span></h2>
			<div class="content">
				<div id="form_wrapper" class="form_wrapper">
					<form class="register" action="daftar.php" method="post">
						<h3>Register</h3>
					...
					<form class="login active" action="login.php" method="post" id="form">
						<h3>Login</h3>
						...
						<div class="bottom">
							...
							<button><a href="utama.php" id="login" data-role="button" data-inline="true" data-theme="b">Log in</a></button>
			...
			<a class="back" href="http://tympanus.net/codrops/2011/01/06/animated-form-switching/"></a>
		</div>
