...
<body>
   ...
   <?php
    ...
    if(isset($_GET['tutor_id'])){
      ...
      if(!empty($id)){
        $sql = mysqli_query($koneksi,"SELECT * FROM tutors WHERE tutor_id = '$id'") or die(mysqli_error());
...
<div class="container-fluid bcontent" >
        ...
        <div class="col-md-3 col-sm-6 my-3 my-md-0">
            <div class="card">
                <center><img  src="assets/images/tutor/<?php echo $data['foto']; ?>" class="rounded-circle" height="180" widht="180"></center> 
                <div class="card-body">
                    <center>
                    <h6>
        ...
        <div class="col-md-7 col-sm-12 mb-3">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title bolde">Description</h5>
                </div>
                <div class="card-body">
                    <p class="card-text"><?php echo $data['deskripsi']; ?></p>
                </div>
                <div class="card-footer">
                    <small class="text-muted">Tutor @PRITECH</small>
                </div>
            </div>
        </div>
    </div>
